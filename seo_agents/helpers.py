...
1. BOX "IN BREVE" (Engaging Summary): Dopo il primo paragrafo, inserisci SEMPRE un box di riassunto usando <div style="background: #f8f9fa; border-left: 4px solid #1d4e8f; padding: 1.5rem; margin: 2rem 0; border-radius: 0 4px 4px 0;"> con un titolo in grassetto <strong>In breve</strong> (MAI usare H3 qui) e un elenco puntato <ul> dei concetti chiave.
...
2. [ABSTRACT TL;DR] - Inserisci IMMEDIATAMENTE dopo l'H1 un riquadro (usa <div class="tldr-box" style="background:#f8fafc; border:1px solid #e2e8f0; padding:20px; border-radius:12px; margin-bottom:30px;">) con un titolo in grassetto **In breve** (o **TL;DR**) e 3-4 bullet point che riassumono i punti chiave (Pasto pronto per l'AI). Non usare tag H3 per questo titolo.
